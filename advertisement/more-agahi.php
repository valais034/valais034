...
<div id="left-more-agahi">
	...
	if($tedad3=="0")
	{
		echo '<div id="like" align=center style="margin:10px 0;"><img src=images/unlike.png width=70 height=70></div>';
	}
	else
	{
		echo '<div id="like" align=center style="margin:10px 0"><img src=images/like.png width=70 height=70></div>';
	}
